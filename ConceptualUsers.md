...
- **Ranking:** The position of an album compared to others in the same year, with a lower number equating to a higher rank.   
- **Tab:** A section of the application that shows a specific way to view or explore album information.   
- **EP (Extended Play):** A shorter music release that is not a full length album.   
- **Live Album:** An album recorded during a live performance.   
- **Vinyl Ownership:** An indicator that shows whether the user owns a physical vinyl copy of an album.   
...
- **Comparison:** Looking at similarities and differences between artists and their albums.  
...
- **Artist Comparison Tab:** Select two artists to compare their album ratings using a visual graph.  
- **Vinyl Tab:** View albums within a selected rating range that are not owned on vinyl.
